...
// source: geo_base/open_street_map/proto/open_street_map.proto
...
void protobuf_AssignDesc_geo_5fbase_2fopen_5fstreet_5fmap_2fproto_2fopen_5fstreet_5fmap_2eproto() {
  protobuf_AddDesc_geo_5fbase_2fopen_5fstreet_5fmap_2fproto_2fopen_5fstreet_5fmap_2eproto();
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_geo_5fbase_2fopen_5fstreet_5fmap_2fproto_2fopen_5fstreet_5fmap_2eproto);
}
...
void protobuf_ShutdownFile_geo_5fbase_2fopen_5fstreet_5fmap_2fproto_2fopen_5fstreet_5fmap_2eproto() {
...
void protobuf_AddDesc_geo_5fbase_2fopen_5fstreet_5fmap_2fproto_2fopen_5fstreet_5fmap_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n4geo_base/open_street_map/proto/open_st"
    "reet_map.proto\022\036geo_base.open_street_map"
    ...
    "index_data\030\002 \001(\014\022\021\n\tdata_size\030\003 \002(\005\"\033\n\016s"
    "tring_table_t\022\t\n\001s\030\001 \003(\014\"\376\001\n\rbasic_group"
    "_t\0225\n\005nodes\030\001 \003(\0132&.geo_base.open_street"
    "_map.proto.node_t\022B\n\013dense_nodes\030\002 \001(\0132-"
    ".geo_base.open_street_map.proto.dense_no"
    "des_t\0223\n\004ways\030\003 \003(\0132%.geo_base.open_stre"
    "et_map.proto.way_t\022=\n\trelations\030\004 \003(\0132*."
    "geo_base.open_street_map.proto.relation_"
    "t\"\334\001\n\rbasic_block_t\022D\n\014string_table\030\001 \002("
    "\0132..geo_base.open_street_map.proto.strin"
    "g_table_t\022C\n\014basic_groups\030\002 \003(\0132-.geo_ba"
    "se.open_street_map.proto.basic_group_t\022\030"
    "\n\013granularity\030\021 \001(\005:\003100\022\022\n\007lat_off\030\023 \001("
    "\003:\0010\022\022\n\007lon_off\030\024 \001(\003:\0010\"R\n\006node_t\022\n\n\002id"
    "\030\001 \002(\022\022\020\n\004keys\030\002 \003(\rB\002\020\001\022\020\n\004vals\030\003 \003(\rB\002"
    ...
    "\n\003lon\030\t \003(\022B\002\020\001\022\017\n\003kvs\030\n \003(\005B\002\020\001\"I\n\005way_"
    "t\022\n\n\002id\030\001 \002(\003\022\020\n\004keys\030\002 \003(\rB\002\020\001\022\020\n\004vals\030"
    "\003 \003(\rB\002\020\001\022\020\n\004refs\030\010 \003(\022B\002\020\001\"\361\001\n\nrelation"
    "_t\022\n\n\002id\030\001 \002(\003\022\020\n\004keys\030\002 \003(\rB\002\020\001\022\020\n\004vals"
    "\030\003 \003(\rB\002\020\001\022\025\n\troles_sid\030\010 \003(\005B\002\020\001\022\026\n\nmem"
    "ber_ids\030\t \003(\022B\002\020\001\022R\n\014member_types\030\n \003(\0162"
    "8.geo_base.open_street_map.proto.relatio"
    "n_t.member_type_tB\002\020\001\"0\n\rmember_type_t\022\010"
    "\n\004NODE\020\000\022\007\n\003WAY\020\001\022\014\n\010RELATION\020\002", 1231);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "geo_base/open_street_map/proto/open_street_map.proto", &protobuf_RegisterTypes);
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_geo_5fbase_2fopen_5fstreet_5fmap_2fproto_2fopen_5fstreet_5fmap_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_geo_5fbase_2fopen_5fstreet_5fmap_2fproto_2fopen_5fstreet_5fmap_2eproto {
  StaticDescriptorInitializer_geo_5fbase_2fopen_5fstreet_5fmap_2fproto_2fopen_5fstreet_5fmap_2eproto() {
    protobuf_AddDesc_geo_5fbase_2fopen_5fstreet_5fmap_2fproto_2fopen_5fstreet_5fmap_2eproto();
  }
} static_descriptor_initializer_geo_5fbase_2fopen_5fstreet_5fmap_2fproto_2fopen_5fstreet_5fmap_2eproto_;
...
const blob_t& blob_t::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_geo_5fbase_2fopen_5fstreet_5fmap_2fproto_2fopen_5fstreet_5fmap_2eproto();
...
void blob_t::clear_raw() {
 ...
 void blob_t::set_raw(const void* value, size_t size) {
  set_has_raw();
...
void blob_t::clear_zlib_data() {
 ...
 void blob_t::set_zlib_data(const void* value, size_t size) {
  set_has_zlib_data();
...
void blob_t::clear_lzma_data() {
 ...
 void blob_t::set_lzma_data(const void* value, size_t size) {
  set_has_lzma_data();
...
void blob_header_t::SharedDtor() {
  ...
  index_data_.DestroyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  if (this != default_instance_) {
  }
}
...
blob_header_t* blob_header_t::New(::google::protobuf::Arena* arena) const {
  blob_header_t* n = new blob_header_t;
  if (arena != NULL) {
    arena->Own(n);
  }
  return n;
...
void blob_header_t::Clear() {
  if (_has_bits_[0 / 32] & 7u) {
    ...
    if (has_index_data()) {
      index_data_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
    }
    data_size_ = 0;
  }
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
...
void blob_header_t::MergeFrom(const blob_header_t& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_index_data()) {
      set_has_index_data();
      index_data_.AssignWithDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), from.index_data_);
    }
...
void blob_header_t::clear_type() {
 ...
 void blob_header_t::set_type(const char* value, size_t size) {
  set_has_type();
...
void blob_header_t::clear_index_data() {
 ...
 const ::std::string& blob_header_t::index_data() const {
  ...
  return index_data_.GetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
 void blob_header_t::set_index_data(const ::std::string& value) {
  set_has_index_data();
  index_data_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
 ...
 void blob_header_t::set_index_data(const char* value) {
  set_has_index_data();
  index_data_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:geo_base.open_street_map.proto.blob_header_t.index_data)
}
 void blob_header_t::set_index_data(const void* value, size_t size) {
  set_has_index_data();
  index_data_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
 ...
 ::std::string* blob_header_t::mutable_index_data() {
  ...
  return index_data_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
 ::std::string* blob_header_t::release_index_data() {
  clear_has_index_data();
  return index_data_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
 void blob_header_t::set_allocated_index_data(::std::string* index_data) {
  ...
  index_data_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), index_data);
...
string_table_t* string_table_t::New(::google::protobuf::Arena* arena) const {
  string_table_t* n = new string_table_t;
  if (arena != NULL) {
    arena->Own(n);
  }
  return n;
...
basic_group_t* basic_group_t::New(::google::protobuf::Arena* arena) const {
  basic_group_t* n = new basic_group_t;
  if (arena != NULL) {
    arena->Own(n);
  }
  return n;
...
::geo_base::open_street_map::proto::dense_nodes_t* basic_group_t::mutable_dense_nodes() {
  ...
  if (dense_nodes_ == NULL) {
    dense_nodes_ = new ::geo_base::open_street_map::proto::dense_nodes_t;
  }
...
basic_block_t* basic_block_t::New(::google::protobuf::Arena* arena) const {
  basic_block_t* n = new basic_block_t;
  if (arena != NULL) {
    arena->Own(n);
  }
  return n;
...
::geo_base::open_street_map::proto::string_table_t* basic_block_t::mutable_string_table() {
  ...
  if (string_table_ == NULL) {
    string_table_ = new ::geo_base::open_street_map::proto::string_table_t;
  }
...
dense_nodes_t* dense_nodes_t::New(::google::protobuf::Arena* arena) const {
  dense_nodes_t* n = new dense_nodes_t;
  if (arena != NULL) {
    arena->Own(n);
  }
  return n;
