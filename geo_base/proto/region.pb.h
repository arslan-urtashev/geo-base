...
#ifndef PROTOBUF_geo_5fbase_2fproto_2fregion_2eproto__INCLUDED
#define PROTOBUF_geo_5fbase_2fproto_2fregion_2eproto__INCLUDED
...
inline void kv_t::set_k(const char* value, size_t size) {
  set_has_k();
...
inline void kv_t::set_v(const char* value, size_t size) {
  set_has_v();
...
#endif  // PROTOBUF_geo_5fbase_2fproto_2fregion_2eproto__INCLUDED
